...
#ifdef __ANDROID__
  __android_log_print(ANDROID_LOG_ERROR, ANDROID_LOG_TAG, "%s", str().c_str());
#else
...
#ifdef __ANDROID__
  __android_log_print(ANDROID_LOG_INFO, ANDROID_LOG_TAG, "%s", str().c_str());
#else
