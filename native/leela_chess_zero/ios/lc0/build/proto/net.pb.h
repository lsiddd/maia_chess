...
inline std::string Weights_Layer_Encoding_Name(Weights_Layer_Encoding val) {
  switch (val) {
    case Weights_Layer_Encoding_UNKNOWN_ENCODING:
      return "UNKNOWN_ENCODING";
    case Weights_Layer_Encoding_LINEAR16:
      return "LINEAR16";
    case Weights_Layer_Encoding_FLOAT16:
      return "FLOAT16";
    case Weights_Layer_Encoding_BFLOAT16:
      return "BFLOAT16";
    case Weights_Layer_Encoding_FLOAT32:
      return "FLOAT32";
  };
...
class Weights_Layer final : public lczero::ProtoMessage {
 public:
  using Encoding = Weights_Layer_Encoding;
  ...
  static constexpr std::array<Encoding,5> Encoding_AllValues = {
    UNKNOWN_ENCODING,
    LINEAR16,
    FLOAT16,
    BFLOAT16,
  ...
  static std::string Encoding_Name(Encoding val) {
    return Weights_Layer_Encoding_Name(val);
  }
  ...
  Weights_Layer_Encoding encoding() const;
  void set_encoding(Weights_Layer_Encoding val);

  void add_dims(std::uint32_t val);
  const std::vector<std::uint32_t>& dims() const;
  std::vector<std::uint32_t>* mutable_dims();
  std::uint32_t dims(size_t idx) const;
 ...
 private:
  ...
  std::string params_{};
  bool has_encoding_{};
  Weights_Layer_Encoding encoding_{};
...
class Weights_MHA final : public lczero::ProtoMessage {
 public:
  ...
  const Weights_Layer& rpe_q() const;
  Weights_Layer* mutable_rpe_q();

  bool has_rpe_k() const;
  const Weights_Layer& rpe_k() const;
  Weights_Layer* mutable_rpe_k();

  bool has_rpe_v() const;
  const Weights_Layer& rpe_v() const;
  Weights_Layer* mutable_rpe_v();
 ...
 private:
  ...
  bool has_rpe_q_{};
  Weights_Layer rpe_q_{};
  bool has_rpe_k_{};
  Weights_Layer rpe_k_{};
  bool has_rpe_v_{};
  Weights_Layer rpe_v_{};
};
...
inline std::string Weights_Layer::OutputAsString() const {
  ...
  if (has_encoding_) AppendVarInt(4, encoding_, &out);
  for (const auto& x : dims_) AppendVarInt(5, x, &out);
  return out;
}
inline std::string Weights_Layer::OutputAsJson() const {
  ...
  if (has_encoding_) AppendJsonField("encoding", Weights_Layer_Encoding_Name(encoding_), &first, &out);
...
inline void Weights_Layer::SetVarInt(int field_id, std::uint64_t val) {
  switch (field_id) {
    case 4: set_encoding(static_cast<Weights_Layer_Encoding>(val)); break;
    case 5: dims_.emplace_back(static_cast<std::uint32_t>(val)); break;
  }
}
...
inline bool Weights_Layer::has_encoding() const { return has_encoding_; }
inline Weights_Layer_Encoding Weights_Layer::encoding() const { return encoding_; }
inline void Weights_Layer::set_encoding(Weights_Layer_Encoding val) {
  has_encoding_ = true;
  encoding_ = val;
}
inline void Weights_Layer::add_dims(std::uint32_t val) { dims_.emplace_back(val); }
inline const std::vector<std::uint32_t>& Weights_Layer::dims() const { return dims_; }
inline std::vector<std::uint32_t>* Weights_Layer::mutable_dims() { return &dims_; }
inline std::uint32_t Weights_Layer::dims(size_t idx) const { return dims_[idx]; }
inline size_t Weights_Layer::dims_size() const { return dims_.size(); }
...
inline std::string Weights_MHA::OutputAsString() const {
  ...
  if (has_rpe_q_) AppendString(10, rpe_q_.OutputAsString(), &out);
  if (has_rpe_k_) AppendString(11, rpe_k_.OutputAsString(), &out);
  if (has_rpe_v_) AppendString(12, rpe_v_.OutputAsString(), &out);
  return out;
}
inline std::string Weights_MHA::OutputAsJson() const {
  ...
  if (has_rpe_q_) AppendJsonField("rpe_q", rpe_q_, &first, &out);
  if (has_rpe_k_) AppendJsonField("rpe_k", rpe_k_, &first, &out);
  if (has_rpe_v_) AppendJsonField("rpe_v", rpe_v_, &first, &out);
  out += "}";
  return out;
}
...
inline void Weights_MHA::SetString(int field_id, std::string_view val) {
  switch (field_id) {
    ...
    case 10: mutable_rpe_q()->MergeFromString(val); break;
    case 11: mutable_rpe_k()->MergeFromString(val); break;
    case 12: mutable_rpe_v()->MergeFromString(val); break;
  }
}
...
inline bool Weights_MHA::has_rpe_q() const { return has_rpe_q_; }
inline const Weights_Layer& Weights_MHA::rpe_q() const { return rpe_q_; }
inline Weights_Layer* Weights_MHA::mutable_rpe_q() {
  has_rpe_q_ = true;
  return &rpe_q_;
}
inline bool Weights_MHA::has_rpe_k() const { return has_rpe_k_; }
inline const Weights_Layer& Weights_MHA::rpe_k() const { return rpe_k_; }
inline Weights_Layer* Weights_MHA::mutable_rpe_k() {
  has_rpe_k_ = true;
  return &rpe_k_;
}
inline bool Weights_MHA::has_rpe_v() const { return has_rpe_v_; }
inline const Weights_Layer& Weights_MHA::rpe_v() const { return rpe_v_; }
inline Weights_Layer* Weights_MHA::mutable_rpe_v() {
  has_rpe_v_ = true;
  return &rpe_v_;
}
